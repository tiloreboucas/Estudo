...
<body id="confirmacao"> 
		...
		<div id="main" class="clearfix">
			<section>				
				...
				<article class="content">
					<div class="form">
						<div>
							<h3 class="confirmacaoEmail">Confirmação de e-mail:</h3>
							<fieldset>
							    <div id="stage" class=""><span id="stage_text"></span></div>
							</fieldset>
						</div>
					</div>
				</article>
    ...
    <script type="text/javascript">loadConfirmacao();</script>
   <!-- Google Code for Cadastro Conversion Page -->
    <script type="text/javascript">
        /* <![CDATA[ */
        var google_conversion_id = 995988942;
        var google_conversion_language = "en";
        var google_conversion_format = "3";
        var google_conversion_color = "ffffff";
        var google_conversion_label = "IOHaCIqx5AMQzqv22gM";
    ...
    <noscript>
        <div style="display:inline;">
            <img height="1" width="1" style="border-style:none;" alt="" src="http://www.googleadservices.com/pagead/conversion/995988942/?value=1&amp;label=IOHaCIqx5AMQzqv22gM&amp;guid=ON&amp;script=0"/>
        </div>
    </noscript>
</body>
</html>